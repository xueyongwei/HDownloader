...
- (void)_InnershowStatusBarNotification:(NSString *)message forDuration:(CGFloat)duration {
    if (!self.statusBarNotificationIsShowing) {
        ...
        self.statusBarNotificationLabel.numberOfLines = 1;
        self.statusBarNotificationLabel.lineBreakMode = NSLineBreakByTruncatingMiddle;
        self.statusBarNotificationLabel.textAlignment = NSTextAlignmentCenter;
        self.statusBarNotificationLabel.alpha = 1.0;
        self.statusBarNotificationLabel.backgroundColor = [UIColor colorWithHexString:@"2d98ff"];
